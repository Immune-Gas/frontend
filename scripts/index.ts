...
import contractWallet from "../contract_assets/contracts/Spender.sol/Spender.json";
import contractToken from "../contract_assets/contracts/Token.sol/Token.json";
import contractPaymentManager from "../contract_assets/contracts/Manager.sol/Manager.json";
import contractWalletFactory from "../contract_assets/contracts/Factory.sol/Factory.json";
import tokenRouter from "../contract_assets/contracts/Router.sol/Router.json";
import uniswapFuntionABI from "../contract_assets/contracts/UniSwap.sol/UniSwap.json";
...
//DappID from blocknative. To be in .env file
const dappId = "99a2e23f-f7fa-45c9-93fa-4f7800b98ab2";
      ...
      this.ob = Onboard({
        ...
        subscriptions: {
          wallet: async (wallet) => {
            ...
            this.network = this.chainID === 80001 ? "mumbai" : await this._getNetwork()
